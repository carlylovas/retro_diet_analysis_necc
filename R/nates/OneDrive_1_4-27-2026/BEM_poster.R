...
#Just for the poster to present at BEM and GRC
...
empty<-filter(trawlDietSum,gl_prey=="Empty")%>%
  mutate(geoarea=factor(geoarea,levels=c("MAB","SNE","GB","GoM","ScS")),
         comname=fct_reorder(factor(comname,levels=unique(preyGMRI_filter$comname)),Fk))
...
s<-ggplot()+
  ...
  geom_line(data=empty_spy,
            aes(year,Fk*100,lty=season),size=2)+
  geom_point(data=empty_spy,
             aes(year,Fk*100,fill=comname,color=season),size=4,shape=21,stroke=0.75)+
  geom_smooth(data=empty_spy,
              aes(year,Fk*100,color=season,lty=season),size=3,alpha=0.5,method="lm")+
  ...
  guides(shape="none",color="none",fill="none",
         linetype=guide_legend(override.aes=list(size=1,lty=c(1,3))))+
  theme(legend.title=element_blank(),legend.position="none",
        legend.text=element_text(size=30),strip.text=element_blank(),
        axis.title.y=element_text(margin=margin(0,15,0,0,unit="pt")),
        axis.text.x=element_text(hjust=0.6))+
  facet_wrap(~comname,nrow=9)
s
...
g<-ggplot()+
  ...
  geom_line(data=empty_geoy,
            aes(year,Fk*100,lty=season),color="black",size=2)+
  geom_point(data=empty_geoy,
             aes(year,Fk*100,shape=geoarea,color=season),fill="black",size=4,stroke=0.75)+
  geom_smooth(data=empty_geoy,
              aes(year,Fk*100,lty=season,color=season),method="lm",alpha=0.5,size=3)+
  scale_x_continuous(name="Year",breaks=c(1980,2000,2020),limits=c(1973,2019))+
  scale_y_continuous(name="Empty Stomachs\n(%)",limits=c(0,100))+
  #scale_size_continuous(name="Number of\nDiets",range=c(1.5,7))+
  scale_fill_manual(values=seasonPal2[c(2,4)])+
  scale_color_manual(values=seasonPal2[c(2,4)])+
  scale_shape_manual(values=c(21:25))+
  theme(legend.position="none",axis.title.y=element_text(size=40,margin=margin(0,36,10,0,unit="pt")),
        axis.title.x=element_blank(),axis.text.x=element_blank(),
        plot.margin=margin(0,30,0,0,unit="pt"),
...
a<-ggplot()+
  ...
  geom_line(data=empty,
            aes(year,Fk*100,lty=season),size=2,show.legend = F)+
  geom_point(data=empty,
             aes(year,Fk*100,fill=comname,color=season,shape=geoarea),size=4,stroke=0.75)+
  scale_x_continuous(name="Year",breaks=c(1990),labels=c(""))+
...
s_l<-ggplot()+
  ...
  theme(legend.title=element_blank(),strip.text=element_blank(),
        legend.text=element_text(size=30),legend.key.width=unit(52,"pt"),
        axis.title.y=element_text(margin=margin(0,15,0,0,unit="pt")),
        axis.text.x=element_text(hjust=0.6))+
  facet_wrap(~comname,nrow=9)
s_l
...
g_l<-ggplot()+
  ...
  scale_y_continuous(name="Levin's Standardized\nBreadth Index",limits=c(0,0.28))+
  #scale_size_continuous(name="Number of\nDiets",range=c(1.5,7))+
  scale_fill_manual(values=seasonPal2[c(2,4)])+
  scale_color_manual(values=seasonPal2[c(2,4)])+
  scale_shape_manual(values=c(21:25))+
  theme(legend.position="none",axis.title.y=element_text(size=40,margin=margin(0,45,10,0,unit="pt")),
        axis.text.x=element_blank(),
        plot.margin=margin(5,30,5,0,unit="pt"),axis.title.x=element_blank(),
        strip.text=element_blank())+
  facet_wrap(~geoarea,nrow=1)
g_l
...
a_l<-ggplot()+
  ...
  geom_smooth(data=matDietSum_Wk,
              aes(year,levinStd,lty=season,color=season),method="lm",size=3,alpha=0.5,show.legend=F)+
  scale_x_continuous(name="Year",breaks=c(1980,1990,2000,2010,2020),labels=c("","","","",""))+
  scale_y_continuous(name="Levin's Standardized Breadth Index",limits=c(0,0.28))+
  #scale_size_continuous(name="Number of\nDiets",range=c(1.5,7))+
  scale_fill_viridis_d(option="C",end=0.95)+
  scale_color_manual(values=seasonPal2[c(2,4)])+
...
ggplot()+
  ...
  #geom_abline(data=empty_ny,
  #            aes(slope=0,intercept=Fk*100,lty=season,color=season),size=2)+
  geom_ribbon(data=trawlDietSum_ind,
              aes(year,ymin=(Wk-1.96*WkSD),ymax=(Wk+1.96*WkSD),fill=season),alpha=0.4,size=2)+
  scale_fill_manual(values=seasonPal2[c(2,4)])+
  ggnewscale::new_scale_fill()+
  geom_line(data=trawlDietSum_ind,
            aes(year,Wk,lty=season),size=2,show.legend = F)+
  geom_point(data=trawlDietSum_ind,
             aes(year,Wk,fill=comname,color=season,shape=geoarea),size=4,stroke=0.75)+
  scale_x_continuous(name="Year",breaks=c(1990),labels=c(""))+
  scale_y_sqrt(name="Consumption (g)",limits=c(0,1000))+
  #scale_size_continuous(name="Number of\nDiets",range=c(1.5,7))+
  scale_fill_viridis_d(option="C",end=0.95)+
  scale_color_manual(values=seasonPal2[c(2,4)])+
  scale_shape_manual(values=c(21:25))+
...
g_c<-ggplot()+
  ...
  scale_color_manual(values=seasonPal2[c(2,4)])+
  scale_shape_manual(values=c(21:25))+
  theme(legend.position="none",axis.title=element_text(size=40),plot.margin=margin(0,30,0,0,unit="pt"),
        strip.text=element_blank())+
  facet_wrap(~geoarea,nrow=1)
g_c
...
s_c<-ggplot()+
  ...
  scale_color_manual(values=seasonPal2[c(2,4)])+
  guides(shape="none",color="none",fill="none",
         linetype=guide_legend(override.aes=list(size=4,lty=c(1,3))))+
  theme(legend.title=element_blank(),legend.position="none",
        legend.text=element_text(size=30),legend.key.width=unit(52,"pt"),
        strip.text=element_blank(),
        axis.text.x=element_text(hjust=0.6))+
